const CONFIG = {
  ...
  individualItems: [
    ...
    { name: "Запчасти для пда", deathDrop: true, weight: 0.7, repPerUnit: 18, price: 9000 },
    { name: "Огромный артефактный фрагмент", deathDrop: true, weight: 0.5, repPerUnit: 2, price: 1500 },
    { name: "Обычный артефактный фрагмент", deathDrop: true, weight: 0.3, repPerUnit: 2, price: 1500 },
    { name: "Остатки приборов «Шепота»", deathDrop: true, weight: 2.5, repPerUnit: 95, price: 65000 },
    { name: "Фильтр", deathDrop: true, weight: 0.5, repPerUnit: 12, price: 5500 },
    { name: "Драгоценности", deathDrop: true, weight: 0.2, repPerUnit: 65, price: 55000 },
    { name: "Малый артефактный фрагмент", deathDrop: true, weight: 0.2, repPerUnit: 1, price: 1000 },
    { name: "Рука сильного шныря", deathDrop: true, weight: 0.5, repPerUnit: 9, price: 5500 },
    { name: "Протоартефакт", deathDrop: true, weight: 0, repPerUnit: 4, price: 2600 },
    { name: "Большой ящик с продовольствием", deathDrop: true, weight: 6, repPerUnit: 9, price: 6000 },
    { name: "Черная селезенка", deathDrop: true, weight: 1.6, repPerUnit: 150, price: 170000 },
    { name: "Сердце Лимб", deathDrop: true, weight: 3, repPerUnit: 1000, price: 1000000 },
    { name: "Лоскут светящейся кожи", deathDrop: true, weight: 0.4, repPerUnit: 15, price: 7000 },
    { name: "Глаз сильного бурелома", deathDrop: true, weight: 1, repPerUnit: 15, price: 10000 },
    { name: "Медная катушка", deathDrop: true, weight: 0.3, repPerUnit: 10, price: 6000 },
    { name: "Кость мутанта", deathDrop: true, weight: 2, repPerUnit: 6, price: 5500 },
    { name: "Медицинские инструменты", deathDrop: true, weight: 0.3, repPerUnit: 20, price: 25000 },
    { name: "Комплект заводских инструментов", deathDrop: true, weight: 0.4, repPerUnit: 11, price: 8500 },
    { name: "Блок данных «Лямбда»", deathDrop: false, weight: 0.2, repPerUnit: 150, price: 190000 },
    { name: "Прототипы «Шепота»", deathDrop: true, weight: 0.3, repPerUnit: 55, price: 40000 },
    { name: "Ящик с деталями", deathDrop: true, weight: 3, repPerUnit: 6, price: 3800 },
    { name: "Крупный артефактный фрагмент", deathDrop: true, weight: 0.4, repPerUnit: 3, price: 1000 },
    { name: "Соленоид", deathDrop: true, weight: 0.4, repPerUnit: 2, price: 4000 },
    { name: "Расцветший Горьколистник", deathDrop: false, weight: 0.05, repPerUnit: 85, price: 140000 },
    { name: "Набор компонентов брони", deathDrop: false, weight: 0.2, repPerUnit: 2, price: 11000 },
    { name: "Темный лимб", deathDrop: false, weight: 0.2, repPerUnit: 90, price: 220000 },
    { name: "Компоненты редких сплавов", deathDrop: true, weight: 0.4, repPerUnit: 35, price: 28000 },
    { name: "Концентрированная лимбоплазма", deathDrop: false, weight: 0.3, repPerUnit: 800, price: 1350000 },
    { name: "Хроносфера", deathDrop: false, weight: 0.25, repPerUnit: 175, price: 385000 },
    { name: "Ноутбук", deathDrop: true, weight: 10, repPerUnit: 12, price: 28000 },
    { name: "Системы наведения", deathDrop: true, weight: 0.4, repPerUnit: 16, price: 27000 },
    { name: "Блок данных «Бета»", deathDrop: false, weight: 0.2, repPerUnit: 45, price: 185000 },
    { name: "Портативный квантовый генератор", deathDrop: false, weight: 3, repPerUnit: 50, price: 65000 },
    { name: "Цветущий рыжий папоротник", deathDrop: false, weight: 0.05, repPerUnit: 12, price: 18000 },
    { name: "Малый ящик с продовольствием", deathDrop: true, weight: 1, repPerUnit: 1, price: 2500 },
    { name: "Ящик с запчастями", deathDrop: true, weight: 2.5, repPerUnit: 1, price: 2600 },
    { name: "Блок данных «Гамма»", deathDrop: false, weight: 0.2, repPerUnit: 45, price: 68000 },
    { name: "Военный радиопередатчик", deathDrop: true, weight: 0.4, repPerUnit: 10, price: 25000 },
    { name: "Блок данных «Альфа»", deathDrop: false, weight: 0.2, repPerUnit: 45, price: 185000 },
    { name: "Модифицированная аномальная батарея", deathDrop: false, weight: 0.45, repPerUnit: 1000, price: 3800000 },
    { name: "Пси-маячок", deathDrop: false, weight: 0.15, repPerUnit: 7, price: 35000 },
    { name: "Очищенное вещество", deathDrop: false, weight: 0.05, repPerUnit: 9, price: 35000 },
    { name: "Промышленные запчасти", deathDrop: true, weight: 0.4, repPerUnit: 6, price: 30000 },
    { name: "Обычный ящик с продовольствием", deathDrop: true, weight: 2, repPerUnit: 3, price: 7000 },
    { name: "Набор компонентов оружия", deathDrop: false, weight: 0.2, repPerUnit: 6, price: 35000 }
  ],
  personalBoxes: [
    { name: "Прочный металл", resourcesNeeded: 2, resourcePrice: 88000 },
    { name: "Сосуд реактора", resourcesNeeded: 2, resourcePrice: 130000 },
    { name: "Измерительное оборудование", resourcesNeeded: 2, resourcePrice: 100000 },
    { name: "Защитное покрытие", resourcesNeeded: 2, resourcePrice: 75000 },
    { name: "Мутаген", resourcesNeeded: 1, resourcePrice: 250000 },
    { name: "Нейродегенерант", resourcesNeeded: 14, resourcePrice: 20000 },
    { name: "Теломераза", resourcesNeeded: 1, resourcePrice: 145000 },
    { name: "Продвинутый электрод", resourcesNeeded: 10, resourcePrice: 25000 },
    { name: "Операционный усилитель", resourcesNeeded: 2, resourcePrice: 85000 },
    { name: "Роторная система", resourcesNeeded: 3, resourcePrice: 65000 },
    { name: "Сверло", resourcesNeeded: 4, resourcePrice: 75000 }
  ],
  nonPersonalBoxes: [
    { name: "Набор болтов", resourcesNeeded: 10, resourcePrice: 18000 },
    ...
    { name: "Пурпурные минералы", resourcesNeeded: 330, resourcePrice: 4000 },
    { name: "Янтарная полынь", resourcesNeeded: 8, resourcePrice: 17000 },
    { name: "Гнозис", resourcesNeeded: 500, resourcePrice: 300 },
    { name: "Электродвигатель", resourcesNeeded: 15, resourcePrice: 15000 },
    { name: "Чертоцвет", resourcesNeeded: 50, resourcePrice: 2000 },
    { name: "Алые минералы", resourcesNeeded: 140, resourcePrice: 1000 },
    { name: "Мутировавшие ферменты", resourcesNeeded: 9, resourcePrice: 12000 },
