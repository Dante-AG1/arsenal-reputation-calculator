const CONFIG = {
  ...
  individualItems: [
    ...
    { name: "Запчасти для пда", deathDrop: true, weight: 0.7, repPerUnit: 18, price: 6700 },
    { name: "Огромный артефактный фрагмент", deathDrop: true, weight: 0.5, repPerUnit: 2, price: 1500 },
    { name: "Обычный артефактный фрагмент", deathDrop: true, weight: 0.3, repPerUnit: 2, price: 600 },
    { name: "Остатки приборов «Шепота»", deathDrop: true, weight: 2.5, repPerUnit: 95, price: 55000 },
    { name: "Фильтр", deathDrop: true, weight: 0.5, repPerUnit: 12, price: 3200 },
    { name: "Драгоценности", deathDrop: true, weight: 0.2, repPerUnit: 65, price: 25000 },
    { name: "Малый артефактный фрагмент", deathDrop: true, weight: 0.2, repPerUnit: 1, price: 400 },
    { name: "Рука сильного шныря", deathDrop: true, weight: 0.5, repPerUnit: 9, price: 4000 },
    { name: "Протоартефакт", deathDrop: true, weight: 0, repPerUnit: 4, price: 2600 },
    { name: "Большой ящик с продовольствием", deathDrop: true, weight: 6, repPerUnit: 9, price: 5700 },
    { name: "Черная селезенка", deathDrop: true, weight: 1.6, repPerUnit: 150, price: 95000 },
    { name: "Сердце Лимб", deathDrop: true, weight: 3, repPerUnit: 1000, price: 750000 },
    { name: "Лоскут светящейся кожи", deathDrop: true, weight: 0.4, repPerUnit: 15, price: 7800 },
    { name: "Глаз сильного бурелома", deathDrop: true, weight: 1, repPerUnit: 15, price: 10000 },
    { name: "Медная катушка", deathDrop: true, weight: 0.3, repPerUnit: 10, price: 5000 },
    { name: "Кость мутанта", deathDrop: true, weight: 2, repPerUnit: 6, price: 4000 },
    { name: "Медицинские инструменты", deathDrop: true, weight: 0.3, repPerUnit: 20, price: 15000 },
    { name: "Комплект заводских инструментов", deathDrop: true, weight: 0.4, repPerUnit: 11, price: 7000 },
    ...
    { name: "Ящик с деталями", deathDrop: true, weight: 3, repPerUnit: 6, price: 2000 },
    { name: "Крупный артефактный фрагмент", deathDrop: true, weight: 0.4, repPerUnit: 3, price: 1000 },
    { name: "Соленоид", deathDrop: true, weight: 0.4, repPerUnit: 2, price: 2000 },
    { name: "Расцветший Горьколистник", deathDrop: false, weight: 0.05, repPerUnit: 85, price: 90000 },
    { name: "Набор компонентов брони", deathDrop: false, weight: 0.2, repPerUnit: 2, price: 2000 },
    { name: "Темный лимб", deathDrop: false, weight: 0.2, repPerUnit: 90, price: 120000 },
    { name: "Компоненты редких сплавов", deathDrop: true, weight: 0.4, repPerUnit: 35, price: 28000 },
    { name: "Концентрированная лимбоплазма", deathDrop: false, weight: 0.3, repPerUnit: 800, price: 810000 },
    { name: "Хроносфера", deathDrop: false, weight: 0.25, repPerUnit: 175, price: 200000 },
    { name: "Ноутбук", deathDrop: true, weight: 10, repPerUnit: 12, price: 20000 },
    { name: "Системы наведения", deathDrop: true, weight: 0.4, repPerUnit: 16, price: 19000 },
    ...
    { name: "Цветущий рыжий папоротник", deathDrop: false, weight: 0.05, repPerUnit: 12, price: 13000 },
    { name: "Малый ящик с продовольствием", deathDrop: true, weight: 1, repPerUnit: 1, price: 2000 },
    { name: "Ящик с запчастями", deathDrop: true, weight: 2.5, repPerUnit: 1, price: 1600 },
    { name: "Блок данных «Гамма»", deathDrop: false, weight: 0.2, repPerUnit: 45, price: 60000 },
    { name: "Военный радиопередатчик", deathDrop: true, weight: 0.4, repPerUnit: 10, price: 30000 },
    { name: "Блок данных «Альфа»", deathDrop: false, weight: 0.2, repPerUnit: 45, price: 75000 },
    { name: "Модифицированная аномальная батарея", deathDrop: false, weight: 0.45, repPerUnit: 1000, price: 2200000 },
    { name: "Пси-маячок", deathDrop: false, weight: 0.15, repPerUnit: 7, price: 18000 },
    { name: "Очищенное вещество", deathDrop: false, weight: 0.05, repPerUnit: 9, price: 21000 },
    { name: "Промышленные запчасти", deathDrop: true, weight: 0.4, repPerUnit: 6, price: 15000 },
    { name: "Обычный ящик с продовольствием", deathDrop: true, weight: 2, repPerUnit: 3, price: 2000 },
    { name: "Набор компонентов оружия", deathDrop: false, weight: 0.2, repPerUnit: 6, price: 33000 }
  ],
  personalBoxes: [
    { name: "Прочный металл", resourcesNeeded: 2, resourcePrice: 60000 },
    { name: "Сосуд реактора", resourcesNeeded: 2, resourcePrice: 110000 },
    { name: "Измерительное оборудование", resourcesNeeded: 2, resourcePrice: 55000 },
    { name: "Защитное покрытие", resourcesNeeded: 2, resourcePrice: 70000 },
    { name: "Мутаген", resourcesNeeded: 1, resourcePrice: 180000 },
    { name: "Нейродегенерант", resourcesNeeded: 14, resourcePrice: 15000 },
    { name: "Теломераза", resourcesNeeded: 1, resourcePrice: 115000 },
    ...
    { name: "Роторная система", resourcesNeeded: 3, resourcePrice: 85000 },
    { name: "Сверло", resourcesNeeded: 4, resourcePrice: 30000 }
  ],
  nonPersonalBoxes: [
    { name: "Набор болтов", resourcesNeeded: 10, resourcePrice: 11000 },
    ...
    { name: "Пурпурные минералы", resourcesNeeded: 330, resourcePrice: 250 },
    { name: "Янтарная полынь", resourcesNeeded: 8, resourcePrice: 10000 },
    { name: "Гнозис", resourcesNeeded: 500, resourcePrice: 800 },
    ...
    { name: "Мутировавшие ферменты", resourcesNeeded: 9, resourcePrice: 9000 },
    { name: "Золотые минералы", resourcesNeeded: 20, resourcePrice: 6000 }
  ]
};
